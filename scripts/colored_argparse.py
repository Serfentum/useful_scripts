...
# Usage
# Locate this file in directory with your script where you use argparse
# import statement - from colored_argparse import ColoredArgParser
# replace argparse.ArgumentParser() with ColoredArgParser() in your script

# Original code
# https://stackoverflow.com/questions/47155189/how-to-output-color-using-argparse-in-python-if-any-errors-happen
